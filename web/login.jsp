    ...
    <section>
        ...
        <div class="panel panel-signin">
            <div class="panel-body">
                ...
                <div class="mb30"></div>
                <form method="post" class="signin" action="<%=request.getContextPath()%>/j_spring_security_check">
                    ...
                    <div class="clearfix"  align="center">
                        <label for="pass">Forgot Password?</label> <a href="forgotPass.jsp"> Reset it now</a>
                    </div>  
