    ...
    <div class="row">
		...
		--%>
		   ...
		   <div class="form-group">  
			  ...
			  <div class="col-sm-2">
			      <form:select id="accessId" path="accessId" cssClass="width300">
	   ...
	   <form:hidden path="accessId" value="2"/> 
           ...
           <div class="form-group">
	      <button class="btn btn-danger mr5" type="submit">ADD USERGROUP</button>
      ...
      <c:if test="${!empty userGroups}">  
          <div class="media-body"><h4>LIST OF USERGROUPS</h4></div>
	     <table id="usergroup-list" class="table table-striped table-bordered responsive">  
		 <thead>
	      <tr>  
	       <th>ID</th>  
	       <th>Code</th>  
...
<tbody>
		...
		<td><c:out value="${usergroup.code}"/></td>  
		<td><c:out value="${usergroup.description}"/></td>  
		<td align="center"><a href="editUserGroup.htm?id=${usergroup.id}">Edit</a></td>  
	       </tr>  
	      </c:forEach>  
		  </tbody>
	     </table>  
