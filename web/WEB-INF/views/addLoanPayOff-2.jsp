     ...
     <div class="row">
         <div class="col-md-10">
             ...
             <div class="col-md-15">
				  ...
				  <form:form method="post" action="saveLoanPayOff.htm" commandName="loanPayOff">
					  <%--
					     <div class="form-group">
							  <form:label path="id" cssClass="col-sm-3 control-label">ID:</form:label>
							  <div class="col-sm-8">
								 <form:input path="id" value="${loanPayOff.id}" readonly="true"/>
							  </div>
					     </div>
					  --%>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
						  ...
						  <div class="col-sm-8">
							 <form:input path="loanCaseId" value="${loanPayOff.loanCaseId}" readonly="true"/>
							 <form:errors path="loanCaseId" cssClass="error"></form:errors>
						  </div>
					   </div>
					   <fmt:formatNumber type="number" maxFractionDigits="2" var="PrlTotal" value="${loanPayOff.repayTotPrl}" />

					   <div class="form-group">
						  <form:label path="repayTotPrl" cssClass="col-sm-3 control-label">Principal Amount (Total):</form:label>
						  <div class="col-sm-8">
							 <form:input path="repayTotPrl" value="${loanPayOff.repayTotPrl}"  readonly="true"/>
							 <form:errors path="repayTotPrl" cssClass="error"></form:errors>
						  </div>
					   </div>
					   
					   <fmt:formatNumber type="number" maxFractionDigits="2" var="intTotal" value="${loanPayOff.repayTotInt}" />
					   
					   <div class="form-group">
						  <form:label path="repayTotInt" cssClass="col-sm-3 control-label">Interest Amount (Total)::</form:label>
						  <div class="col-sm-8">
							 <form:input path="repayTotInt" value="${loanPayOff.repayTotInt}" readonly="true"/>
							 <form:errors path="repayTotInt" cssClass="error"></form:errors>
						  </div>
					   </div>
					   
					   <fmt:formatNumber type="number" maxFractionDigits="2" var="repayPenaltyT" value="${loanPayOff.repayPenalty}" />

					   <div class="form-group">
						  <form:label path="repayPenalty" cssClass="col-sm-3 control-label">Total Penalty:</form:label>
						  <div class="col-sm-8">
							 <form:input path="repayPenalty" value="${loanPayOff.repayPenalty}"  readonly="true"/>
							 <form:errors path="repayPenalty" cssClass="error"></form:errors>
						  </div>
					   </div>
					   
					   <fmt:formatNumber type="number" maxFractionDigits="2" var="loanTotal" value="${loanPayOff.repayTotAmt}" />

					   <div class="form-group">
						  <form:label path="repayTotAmt" cssClass="col-sm-3 control-label">Loan Amount:</form:label>
						  <div class="col-sm-8">
							 <form:input path="repayTotAmt" value="${loanPayOff.repayTotAmt}"  readonly="true"/>
