...
<div class="media-body">
       <div style="float:left">
		...
		<li><a href="#">Home</a></li>
		<li>Loan Config Management</li>
	    </ul>
	    <h4>Edit Branch Loan Configuration</h4>
	</div>
        ...
        <div class="col-md-10">
	       ...
	       <div class="panel-body">
		      ...
		      <form:form method="post" action="saveAppConfig.htm" commandName="appConfig">
			   ...
			   <div class="form-group"> 
				  <form:label id="companyId" path="companyId" cssClass="col-sm-3 control-label"> select Cooperative *:</form:label>
				  <div class="col-sm-8">
			  ...
			  <div class="form-group">   
			   ...
			   <div id="formula1" class="form-group">   
				  ...
				  <div class="col-sm-8">
				      <form:select id="formulaValue" path="formulaValue">
					   <form:option value="">--select--</form:option>
					   <form:option value="SYM001">TOTAL MEMBER SAVINGS</form:option>
				      </form:select>
...
<script>
    $(document).ready(function(){
         ...
         jQuery('select').select2({
				 ...
				 jQuery('#appconfig-list').DataTable({
                    responsive: true
                });
    })
</script>
