...
<div class="media-body">
  <div style="float:left">
    <ul class="breadcrumb">
        ...
        <li>Journal Postings Approval Confirmation</li>
    </ul>
    <h4>Confirm Journal Postings Approval</h4>
  </div>  
...
<div class="contentpanel">
    ...
    <form:form method="post" action="gl_pfjrnltxnapprv.htm" modelAttribute="batchfile">  
                <div class="panel-body">
