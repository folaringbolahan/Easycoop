...
<p>
    ...
    <p>  
       <button class="btn btn-success mr5" id="downloadexcel" name="action" onClick="javascript:form.action = '<%=request.getContextPath()%>/gl/gl_downloadrecs/${dBatchId}/${nm}.htm'" value="Download">DOWNLOAD FILE</button>
    </p>   
