    ...
    <section>
        ...
        <div class="panel panel-signin">
            <div class="panel-body">
                ...
                <div class="mb30"></div>
                <form method="post" class="signin" action="<%=request.getContextPath()%>/votes/j_spring_security_check" id="theform">
                    ...
                    <c:if test="${(not empty param.mg) && (param.mg eq 'sc')}">
                        <div class="alert alert-success">
                            <p><h5 align="center">Your vote has been submitted successfully !</h5></p>
                        </div>
                    </c:if> 
                    ...
                    <div class="clearfix">
                        <div class="pull-left">
                            ...
                            <input type="hidden" id="refid" value="4">
