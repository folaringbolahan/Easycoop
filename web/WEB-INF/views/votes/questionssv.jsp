	                                                ...
	                                                <div class="col-sm-8">
	                                                     ...
	                                                     <c:choose>
                                                                 <c:when test="${dvotedetails.electionanswertypeid == 2}">
                                                                     <input id="${optionitem.id}" name="${query2}" type="checkbox" value="${optionitem.id}" class=" col-sm-4" />&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                jQuery('#basicWizard').bootstrapWizard({
                    ...
                    onTabClick: function(tab, navigation, index) {
                     ...
                     //console.log("total " + $totalx);
                          if($totalm > $('#usrnoofvotes').val())
                           {  
                            alert("Total vote unit specified is more than your vote units - " + $totalm + " > " + $('#usrnoofvotes').val());   
