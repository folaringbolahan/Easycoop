<%-- 
    Document   : savingsfailedUpload
    Created on : Jul 26, 2016, 6:32:58 PM
...
<div class="media-body">
    <div style="float:left">
        ...
        <h4>Failed Contribution/Savings Upload</h4>
    </div>
            ...
            <tbody>
                 <c:forEach  var="upload" items="${uploads}" varStatus="status" >
                    <tr>
                        ...
                        <td><a href="savingsuploaderror/${upload.referenceNumber}">${upload.referenceNumber} </td> 
