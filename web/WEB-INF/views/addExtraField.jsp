    ...
    <div class="row">
        <div class="col-md-8">
	     ...
	     <div class="panel-body">	      
                 <form:form method="post" action="saveMemberExtraField" commandName="memberExtraField">
     ...
     <c:if test="${!empty listAllFields}">  
	     ...
	     <table id="addrtype-list" class="table table-striped table-bordered responsive">  
	      ...
	      <c:forEach items="${listAllFields}" var="membExtFlds">  
	       <tr>  
		...
		<td><c:out value="${membExtFlds.grouped}"/></td>  
                ...
                <td><a href="editMemberExtraField.htm?id=${membExtFlds.id}">Edit</a> &nbsp; | &nbsp; <a href="deleteMemberExtraField.htm?id=${membExtFlds.id}">Delete</a> </td>  
