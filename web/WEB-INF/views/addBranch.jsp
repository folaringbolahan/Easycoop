	       ...
	       <div class="panel-body">
			...
			<%--
			   <div class="form-group">  
				  ...
				  <div class="col-sm-2">
				    <form:input path="branchCode" value="${branch.branchCode}"/>
				  </div>  
			   </div>
			--%>
			   ...
			   <%--
				   <div class="form-group">   
					  ...
					  <div class="col-sm-2">
					     <form:input path="currentPeriod" value="${branch.currentPeriod}" />
					  </div>  
				   </div>
				   ...
				   <div class="form-group">   
					  ...
					  <div class="col-sm-2">
					     <form:input path="currentYear" value="${branch.currentYear}"/>
					  </div>  
				   </div> 
			   --%>
			   ...
			   <div class="form-group"> 
				  ...
				  <div class="col-sm-2">
				     <form:select id="currentPeriod" path="currentPeriod" cssClass="width300" >
			   ...
			   <div class="form-group"> 
				  <form:label path="currentYear" cssClass="col-sm-4 control-label">Current Year: *</form:label>
				  <div class="col-sm-2">
				     <form:select id="currentYear" path="currentYear" cssClass="width300" >
					   <form:option value="">--select--</form:option>
			   ...
			   <div class="form-group">   
				  ...
				  <div class="col-sm-4">
					...
					<form:input path="postDate" value="${branch.postDate}" class="form-control period"  placeholder="dd/mm/yyyy" />
			   ...
			   <div class="form-group">   
				  ...
				  <div class="col-sm-2">
				      <form:select id="baseCurrency" path="baseCurrency" cssClass="width300" >
					<form:option value="">--select--</form:option>
