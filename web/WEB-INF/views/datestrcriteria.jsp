<%-- 
    Document   : loandaterange
    Created on : Aug 9, 2016, 12:31:07 PM
    Author     : OLA
--%>
        ...
        <!-- <div class="panel-body">-->
            ...
            <form:form method="post" action="${reportpath}" modelAttribute="reportdet" >  
                <div class="panel-body">
                    ...
                    <form:label path="strval1" cssClass="col-sm-4 control-label">Id: </form:label>
                            <div class="col-sm-8">
                        ...
                        <br><br> 
                    <div class="form-group">
                     <form:label path="startdatestr" cssClass="col-sm-4 control-label tooltips" data-toggle="tooltip" title="Select start date">From Date: </form:label>
                            <div class="col-sm-4">
                                <div class="input-group">
                    ...
                    <div class="form-group">
                     <form:label path="enddatestr" cssClass="col-sm-4 control-label tooltips" data-toggle="tooltip" title="Select end date">To Date: </form:label>
                            <div class="col-sm-4">
                                <div class="input-group">
