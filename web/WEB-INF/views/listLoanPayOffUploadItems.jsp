...
<div class="media-body">
           <div style="float:left">
			...
			<li><a href="#">Home</a></li>
			<li>Loan PayOff Upload Items View</li>
		    </ul>
		    <h4>Loan PayOff Upload Items</h4>
	   </div>
        ...
        <div class="col-md-12">
	       ...
	       <div class="panel-body">
		      ...
		      <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery-ui-i18n.min.js"></script> 
		       ...
		       <c:if test="${!empty loanpayoffuploaditems}">  
				     <c:set var="count" scope="page" value="0" />
				     <div class="media-body">
					<h4>LOAN PAYOFF UPLOAD ITEMS- VIEW </h4>
				     </div>
					...
					<tbody>
					      <c:forEach items="${loanpayoffuploaditems}" var="item">  
