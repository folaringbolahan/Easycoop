    ...
    <div class="row">
        <div class="col-md-8">
	     ...
	     <div class="panel-body">	
                ...
                <c:set var="optionNos" value='<%= request.getParameter("options") %>' />
                <fmt:parseNumber var="i" type="number" value="${optionNos}" />
                 <form:form method="post" action="electionopts" commandName="votQuest">
			   ...
			   <c:forEach var="i" begin="1" end='${i}'>
		           <div class="form-group">   
		       <form:label path="description" cssClass="col-sm-3 control-label">Option <c:out  value="${i}" /></form:label>
                         
			<div class="col-sm-5">
                       
			<input name="description" class="form-control"  id="description"  required="required" />		      
			</div>  
				   </div>
                           </c:forEach>	
