...
<c:if test="${currrentuserServicex.curruser.mustChangePassword=='Y'}"> 
            <%
                        ...
                        <div class="btn-group btn-group-option">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                               <!-- <li><a href="#"><i class="glyphicon glyphicon-user"></i> My Profile</a></li>
                                ...
                                <li><a href="<%=request.getContextPath()%>/changeMyLogonPass.htm?email=<%=request.getRemoteUser()%>"><i class="glyphicon glyphicon-cog"></i> Change Password</a></li>
