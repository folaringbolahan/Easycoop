    ...
    <div class="row">
        ...
        <div class="form-group">
			   ...
			   <input type="hidden" name="memberId" value="${member.memberId}" />
                           ...
                           <button class="btn btn-danger mr5" type="submit" name="action" value="APPROVE EXIT" > APPROVE EXIT </button> 
		           <button class="btn btn-danger mr5" type="submit" name="action" value="REJECT EXIT" >REJECT</button>
