<%-- 
    Document   : batchAddressList
    Created on : Dec 30, 2015, 8:27:20 PM
    Author     : baydel200
--%>
    ...
    <div class=" col-md-10">
        <table  id="data-list" class="table table-striped table-bordered responsive" >       
           ...
           -->
            ...
            <tbody>
                <c:forEach var="extrfld" items="${listMembers}" >
                    <tr>
                        <td>${extrfld.email1}</td>    
                        <td>${extrfld.extrFieldName} </td>
                        <td>${extrfld.extrFieldValue} </td>
                        <td>${extrfld.recAction}</td>
                        <th><a href="getTemplates.htm?downFile=${failFile}">Download</a></th>
                   <%--     <td>${mem.memberTypeId} </td>
                        <td>${mem.gender}</td>
                        <td>${mem.contribution}</td>
                     </tr>
                   --%>
                </c:forEach>
