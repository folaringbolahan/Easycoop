    ...
    <div class="row">
        <div class="col-md-8">
	       ...
	       <div class="panel-body nopadding">
		     ...
		     <form:form method="post" action="../volunt/apprvMemberVoluntary.htm" commandName="member" class="form-horizontal form-bordered">
        ...
        <div class="form-group">
			   ...
			   <input type="hidden" name="memberId" value="${member.memberId}" />
                           ...
                           <button class="btn btn-danger mr5" type="submit" name="action" value="APPROVE RESIGN" > APPROVE RESIGNATION </button> 
		           <button class="btn btn-danger mr5" type="submit" name="action" value="REJECT RESIGN" >REJECT RESIGNATION</button>
