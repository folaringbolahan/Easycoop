            ...
            <tbody>
                <c:forEach var="file" items="${listFiles}" >
                    <tr>
                        ...
                        <td><a href="${file.batchUploadType.viewPassLink}?id=${file.batchUploadFileId}">View</a></td>
                        <td><a href="${file.batchUploadType.viewFailLink}?id=${file.batchUploadFileId}">View</a></td>
                        <td><a href="${file.batchUploadType.valApproveLink}?id=${file.batchUploadFileId}">Validate</a></td>
                        <td><a href="${file.batchUploadType.valRefuseLink}?id=${file.batchUploadFileId}">Reject</a></td>
                    </tr>
                </c:forEach>
