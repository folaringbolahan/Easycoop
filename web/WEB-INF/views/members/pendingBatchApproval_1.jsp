            ...
            <tbody>
                <c:forEach var="file" items="${listFiles}" >
                    <tr>
                        ...
                        <td><a href="batchMemberList.htm?id=${file.batchUploadFileId}">View</a></td>
                        <td><a href="apprMembers.htm?id=${file.batchUploadFileId}" onclick="" > Post</a></td>
                        <td><a href="apprMembersWithout.htm?id=${file.batchUploadFileId}" onclick="" >Approve</a></td>
                        <td><a href="rejMembers.htm?id=${file.batchUploadFileId}">Reject</a></td>
                    </tr>
                </c:forEach>
