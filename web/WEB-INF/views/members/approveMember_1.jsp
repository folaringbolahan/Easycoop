    ...
    <div class="row">
        <div class="col-md-8">
	       ...
	       <div class="panel-body nopadding">
		     ...
		     <form:form method="post" action="approveMember.htm" commandName="member" class="form-horizontal form-bordered">
        ...
        <div class="form-group">
							...
							<form:options items="${referenceList.compList}" itemLabel="name" itemValue="Id"  />
                                   ...
                                   <div class="form-group">
										...
										<c:forEach var="stckList" items="${referenceList.stockList}">
	    										...
	    										<div class="form-group">
	                                                <label class="col-sm-4">${stckList[2]}</label>
	                                                <div class="col-sm-8">
			   ...
			   <input type="hidden" name="memberId" value="${member.memberId}" />
				    ...
				    <button class="btn btn-danger mr5" type="submit" name="action" value="APPROVE"> APPROVE </button> 
				    <button class="btn btn-danger mr5" type="submit" name="action" value="REJECT">REJECT</button>
