<%-- 
    Document   : templates
    Created on : Nov 21, 2015, 11:26:14 AM
    Author     : baydel200
--%>
...
<div class="contentpanel">
    ...
    <div class=" col-md-10">
        <table  id="data-list" class="table table-striped table-bordered responsive" >       
            ...
            <tbody>
                <c:forEach var="file" items="${theFiles}" >
                    <tr>
                        <td>${file[0]} </td>    
                        <td>${file[1]}  </td>
                        <td><a href="getTemplates.htm?downFile=${file[0]}">Download</a></td>
                    </tr>
                </c:forEach>
