...
<div class="media-body">
		...
		<li><a href="#">Home</a></li>
		<li>Extra Field Option Setup</li>
	    </ul>
	    <h4>Extra Field Option Setup</h4>
	</div>
    ...
    <div class="row">
     ...
     <div class="form-group">
      ...
      <c:if test="${!empty memberExtraFieldGrps}">  
          <h4>LIST OF FIELD OPTIONS</h4>  
	     <table id="member-list" class="table table-striped table-bordered responsive  dataTable ">  
	      <thead>
	           <tr>  
		       <th>ID</th>  
		       <th>Group Id</th>  
		...
		<td><c:out value="${membExtFld.groupid}"/></td>
                <td><c:out value="${membExtFld.description}"/></td>
