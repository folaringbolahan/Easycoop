           ...
           <div class="col-md-12">
            ...
            <tbody style=" font-size: 11px; padding: 0px 0px 0px 0px;margin: 0px 0px 0px 0px">
                 <c:forEach var="hpreq4apprv" items="${hpreqs4apprv}" >
                  ...
                  <td><a href="hp_cancelhp.htm?id=${hpreq4apprv.refid}" onclick="return confirm('Cancel Hire Purchase record with reference - ${hpreq4apprv.refid} Continue?')" type="submit" class="buttons" value="Go">Cancel</a> &nbsp;&nbsp;&nbsp; <br>
                  </tr>
                </c:forEach>
