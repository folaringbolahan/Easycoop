...
<div class="media-body">
    <div style="float:left">
        ...
        <h4>Hire Purchase Validation Setup </h4>
    </div>
...
<div class="contentpanel">
    ...
    <div class="row col-md-8">
        ...
        <!-- <div class="panel-body">-->
            <!-- form starts -->
            <form:form method="post" action="hp_validadd.htm" modelAttribute="hpvalidationrules">  
                <div class="panel-body">
                   ...
                   <!-- form-group -->
                          ...
                          <div class="form-group">
                        <form:label path="resultcond" cssClass="col-sm-3 control-label tooltips"  data-original-title="Choose Operator that Formula defined above must evaluate to compared value" data-toggle="tooltip" data-placement="left">Conditional Operator: *</form:label>
                            <div class="col-sm-6">
   ...
   <div class=" col-md-12">
        <table  id="data-list" class="table table-striped table-bordered responsive" >       
            <thead>
                <tr>
                    <th class=" tooltips"  data-original-title="Click to Sort" data-toggle="tooltip" data-placement="top">Code</th>
                    <th class=" tooltips"  data-original-title="Click to Sort" data-toggle="tooltip" data-placement="top">Description</th>
                    <th>Product</th>
                    <th class=" tooltips"  data-original-title="Click to Sort" data-toggle="tooltip" data-placement="top">Rule Type</th>
                    <th>Condition</th>
                    <th>Formula</th>
                    <th></th>
                    <th></th>
            ...
            <tbody>
                <c:forEach var="hpvalidationrule" items="${allhpvalidationrules}" >

                    <tr>
                        <td>${hpvalidationrule.code}</td>    
                        <td>${hpvalidationrule.description}</td>
                        <td>${hpvalidationrule.productcode}</td>
                        <td>${hpvalidationrule.validationtype}</td>
                        <td>${hpvalidationrule.resultcond}</td>
                        <td>${hpvalidationrule.formula}</td>
                        <td><a href="hp_editsettings.htm?id=${hpvalidationrule.id}">Edit</a></td>
                        <td><a href="hp_removesettings.htm?id=${hpvalidationrule.id}" onclick="return confirm('Delete record with code - ${hpvalidationrule.id} Continue?')" type="submit" class="buttons" value="Go">Delete</a></td>
                    </tr>
                </c:forEach>
