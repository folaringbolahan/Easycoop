...
<div class="contentpanel">
    <div class="row">
		...
		<div class="form-group">
		   ...
		   <div class="col-sm-2">
		   	<form:input path="rate" value="${tax.rate}"/> 
		   </div>
                </div>
...
--%>
		...
		<form:hidden path="lastModificationDate" id="lastModificationDate" name="lastModificationDate"   value='<%=new java.text.SimpleDateFormat("dd/MM/yyyy").format(new java.util.Date())%>'/>
               ...
               <div class="form-group">
		    <button class="btn btn-danger mr5" type="button" onclick="Javascript:doSubmit(this.form);">UPDATE TAX</button>
