...
<div class="media-body">
    <div style="float:left">
        <ul class="breadcrumb">
            ...
            <li>Dividend Schedule Report</li>
        </ul>
        <h4>Dividend Schedule Report</h4>
    </div>
            ...
            <form:form method="post" action="${reportpath}" modelAttribute="reportdet">  
                <div class="panel-body">
                    ...
                    <p>
                        ...
                        <form:label path="intval1" cssClass="col-sm-4 control-label tooltips" data-toggle="tooltip" title="Enter Dividend Payment No">Dividend Payment No: </form:label>
                            <div class="col-sm-8">
                             <div class="input-group">
                                     <form:input path="intval1" cssClass="form-control" size="60" />
                                </div>
