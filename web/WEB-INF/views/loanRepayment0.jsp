	       ...
	       <div class="panel-body">
		      ...
		      <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery-ui-i18n.min.js"></script> 
				...
				<h4>OUTSTANDING LOANS</h4>
			     ...
			     <table id="repay-list" class="table table-striped table-bordered responsive">  
				 <thead>
				      <tr>  
				       <th>ID</th>  
				   <%--    
				    ...
				    --%>
				      ...
				      <c:forEach items="${loanRequests}" var="loan">  
						...
						<td align="center"><a href="loanRepayment1.htm?id=${loan.id}">PAY</a></td>  
					       </tr>  
				      </c:forEach>  
			         </tbody>
			    </table>  
		       ...
		       <c:if test="${empty loanRequests}">  
				...
				<h4>THERE IS NO PENDING LOAN REQUESTS</h4>
		             </div>
		       </c:if>
               </div>
            </div><!-- col-md-6 -->
