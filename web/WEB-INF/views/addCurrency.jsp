    ...
    <div class="row">
	    ...
	    --%>
	      ...
	      <div class="form-group">
		   ...
		   <div class="col-sm-2">
		        <form:input id="currencyCode" path="currencyCode" value="${currency.currencyCode}"/> 
	      ...
	      <div class="form-group">
		   <form:label path="currencyName" cssClass="col-sm-4 control-label">Currency Name:</form:label> 
		    <div class="col-sm-2">
            		<form:input id="currencyName" path="currencyName" value="${currency.currencyName}"/>
		   	<form:errors path="currencyName" cssClass="error"></form:errors>
		    </div>
           </div>
        <%--   
	    <div class="form-group">
		   <form:label path="isBase" cssClass="col-sm-4 control-label">Base Currency? Y/N:</form:label> 
		    <div class="col-sm-2">
            		<form:select path="isBase">
        ...
        --%>
           ...
           <form:hidden path="lastModificationDate" id="lastModificationDate" name="lastModificationDate"   value='<%=new java.text.SimpleDateFormat("dd/MM/yyyy").format(new java.util.Date())%>'/>
            <div class="form-group">
                            <button class="btn btn-danger mr5" type="button" onclick="Javascript:doSubmit(this.form);">ADD CURRENCY</button>
