...
<div class="media-body">
           <div style="float:left">
			...
			<li><a href="#">Home</a></li>
			<li>Loan PayOff Upload Errors View</li>
		    </ul>
		    <h4>Loan PayOff Upload Errors</h4>
	   </div>
        ...
        <div class="col-md-12">
	       ...
	       <div class="panel-body">
		      ...
		      <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery-ui-i18n.min.js"></script> 
		       ...
		       <c:if test="${!empty loanpayoffuploaderrors}">  
				     <c:set var="count" scope="page" value="0" />
				     <div class="media-body">
					<h4>LOAN PAYOFF UPLOAD ERRORS- VIEW </h4>
				     </div>
					...
					<tbody>
					      <c:forEach items="${loanpayoffuploaderrors}" var="item">  
						       <c:set var="count" scope="page" value="${count + 1}" />
						       <tr>  
							<td><c:out value="${count}"/></td>  
							<td><a href="viewLoanPayOffUploadError.htm?id=${item.id}">${item.batchId}</a></td>  
