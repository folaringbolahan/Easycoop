package com.sift.loan.utility;
	...
	public class BusinessDayUtil{ 
	    ...
	    public String getCurrentJavaTime(){
	    	String pattern="HHmm";
	    ...
	    private static List<Date> getOfflimitDates(int year){ 
	        ...
	        //Independence Day 
	        baseCalendar.set(year, Calendar.OCTOBER, 1); 
	        offlimitDates.add(offsetForWeekend(baseCalendar)); 
	        ...
	        //Democracy Day 
	        baseCalendar.set(year, Calendar.MAY, 29); 
	        offlimitDates.add(offsetForWeekend(baseCalendar)); 
	    ...
	    private static Date offsetForWeekend(Calendar baseCal){ 
	        ...
	        if (baseCal.get(Calendar.DAY_OF_WEEK) == Calendar.SATURDAY){ 
	                ...
	                return addDays(returnDate,2); /**Now Adjust Date to Monday***/
	     ...
	     *
	     *  
	     *  Return true if the date sent is a weekend
	     * 
	     * 
	     * 
	     ****************************************************************/
	    ...
	    public static Date addMonthsToDate(Date dateTo, int months){ 
	    	//return getNextBusinessDay(DateUtils.addMonths(DateUtils.truncate(dateTo,Calendar.DATE),months));
	    	return DateUtils.addMonths(DateUtils.truncate(dateTo,Calendar.DATE),months);
	    } 

	    public static Date addDaysToDate(Date dateTo, int days){ 
	    	//return getNextBusinessDay(DateUtils.addDays(DateUtils.truncate(dateTo,Calendar.DATE),days));
	    	return DateUtils.addDays(DateUtils.truncate(dateTo,Calendar.DATE),days);
	    } 
	    
	    public static Date addWeeksToDate(Date dateTo, int weeks){ 
	    	//return getNextBusinessDay(DateUtils.addWeeks(DateUtils.truncate(dateTo,Calendar.DATE),weeks));
	    	return DateUtils.addWeeks(DateUtils.truncate(dateTo,Calendar.DATE),weeks);
	    }  
} 