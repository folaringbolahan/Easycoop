...
public class LoanPayOffUploadBean {
	...
	public LoanPayOffUploadBean(){
	}
	
	public LoanPayOffUploadBean(String loanCaseIdStr,String memberNoStr,double amountDbl,Date uploadDate,String uploader){
	...
	public LoanPayOffUploadBean(String loanCaseIdStr,String memberNoStr,double amountDbl,Date uploadDate,String uploader,String validationMessageStr,
