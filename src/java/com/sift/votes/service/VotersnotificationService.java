 ...
 * @author kola
 */
public interface VotersnotificationService {
     // first method
   ...
   /// public boolean firenotification(NotificationService ntc,String username,String agmdescription ,String uri,String email,String clearpass,String  startdate,String starttime,String enddate,String endtime  );
}
