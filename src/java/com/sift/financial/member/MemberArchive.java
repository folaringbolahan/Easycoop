...
/**
 * MemberArchive entity. @author MyEclipse Persistence Tools
 */

public class MemberArchive implements java.io.Serializable {

	// Fields

        private Integer memberArchiveId;   	
	...
	/** minimal constructor */
	public MemberArchive(Integer memberId, String memberCompId, String firstName, String surname,
			Integer memberTypeId, Date createdDate, String createdBy,
			String delFlg, String gender, Integer branchId,
			Integer identificationId, String identificationCode,
			Integer statusId, Integer companyId, String phoneNo1,
			String emailAdd1, String nokName,String nokSurname,String nokPhone) {
	...
	/** full constructor */
	public MemberArchive(Integer memberId,String memberCompId, String firstName,
			String middleName, String surname, Date dob, Integer religionId,
			Integer memberTypeId, Date createdDate, String createdBy,
			...
			Date resignDate, Integer taxGroup, Integer bankId,
			String bankAccount, String modifiedBy, Date modifiedDate,
			String approvedBy, Date approvedDate, String nokName,String nokMiddleName,String nokSurname,String nokPhone, Integer uploadId,Integer batchMemberId) {
                this.memberId = memberId;
		this.memberCompId = memberCompId;
		this.firstName = firstName;
    ...
    // Property accessors
        ...
        public Integer getMemberArchiveId() {
		return memberArchiveId;
	}
        
    public void setMemberArchiveId(Integer memberArchiveId) {
        this.memberArchiveId = memberArchiveId;
    }
