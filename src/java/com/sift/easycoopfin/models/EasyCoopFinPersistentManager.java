...
public class EasyCoopFinPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "EasyCoopFin";
	...
	private EasyCoopFinPersistentManager() throws PersistentException {
           
		super(_connectionSetting, _sessionType, _timeToAlive, new String[] {}, _extraProperties);
                //Properties aProperties = new Properties();
                //aProperties.put("hibernate.connection.datasource", "java:comp/env/jdbc/easycoopfin");
                //setHibernateProperties(aProperties);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EasyCoopFinPersistentManager();
		}
