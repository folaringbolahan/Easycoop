...
/** web service producer to handle account creation for member's products (activated members only) 
 *
 * @author yomi-pc
 */
@Path("/glwsprdacnomem")
//@Autowire
public class ProductaccmemRESTFacade {
    String msgstr = "";
    /**
     *
     */
    public ProductaccmemRESTFacade() {
    }
    ...
    public boolean performAllupdates(String acno,String productcode,Integer companyid,Integer branchid,String subno,String branchcode,String customerno,String timezon){
      ...
      //System.out.println(mySQLString);
       ...
       mySQLString = "select a.first_name,a.middle_name,a.surname from member a where a.company_id = " + companyid + " and a.branch_id = " + branchid + " and member_no = '" + customerno + "'"  ;
       agRecSet = dbobj.retrieveRecset(mySQLString);
       //System.out.println(mySQLString); 
       String memname = "";
