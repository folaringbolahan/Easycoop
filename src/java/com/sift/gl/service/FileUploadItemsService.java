 ...
 */
public interface FileUploadItemsService {
	...
	public List<FileUploadItems> listSuccessBulkUploadItems(String batchId);
        ...
        //public boolean authorizeSingleUpload(int id, String approvedBy);
	...
	public void deleteBulkUploadItem(FileUploadItems item);
        ...
        public List<Custaccountdetails> productAccounts(int companyId, int branchId, String segmentCode);
